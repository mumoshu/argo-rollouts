...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("workloads"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Argoproj().V1alpha1().Workloads().Informer()}, nil
	case v1alpha1.SchemeGroupVersion.WithResource("workloadbalancers"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Argoproj().V1alpha1().WorkloadBalancers().Informer()}, nil
