	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ArgoprojV1alpha1().Workloads(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ArgoprojV1alpha1().Workloads(namespace).Watch(context.TODO(), options)
			},
		},
		&rolloutsv1alpha1.Workload{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *workloadInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&rolloutsv1alpha1.Workload{}, f.defaultInformer)
}
