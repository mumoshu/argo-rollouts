...
func (in *RolloutTrafficRouting) DeepCopyInto(out *RolloutTrafficRouting) {
	*out = *in
	...
	if in.WorkloadBalancer != nil {
		in, out := &in.WorkloadBalancer, &out.WorkloadBalancer
		*out = new(WorkloadBablancerTrafficRouting)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WorkloadBablancerTrafficRouting) DeepCopyInto(out *WorkloadBablancerTrafficRouting) {
	*out = *in
	in.Template.DeepCopyInto(&out.Template)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WorkloadBablancerTrafficRouting.
func (in *WorkloadBablancerTrafficRouting) DeepCopy() *WorkloadBablancerTrafficRouting {
	if in == nil {
		return nil
	}
	out := new(WorkloadBablancerTrafficRouting)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WorkloadBalancer) DeepCopyInto(out *WorkloadBalancer) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WorkloadBalancer.
func (in *WorkloadBalancer) DeepCopy() *WorkloadBalancer {
	if in == nil {
		return nil
	}
	out := new(WorkloadBalancer)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *WorkloadBalancer) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WorkloadBalancerBackend) DeepCopyInto(out *WorkloadBalancerBackend) {
	*out = *in
	if in.Weight != nil {
		in, out := &in.Weight, &out.Weight
		*out = new(int32)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WorkloadBalancerBackend.
func (in *WorkloadBalancerBackend) DeepCopy() *WorkloadBalancerBackend {
	if in == nil {
		return nil
	}
	out := new(WorkloadBalancerBackend)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WorkloadBalancerList) DeepCopyInto(out *WorkloadBalancerList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]WorkloadBalancer, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WorkloadBalancerList.
func (in *WorkloadBalancerList) DeepCopy() *WorkloadBalancerList {
	if in == nil {
		return nil
	}
	out := new(WorkloadBalancerList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *WorkloadBalancerList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WorkloadBalancerSpec) DeepCopyInto(out *WorkloadBalancerSpec) {
	*out = *in
	if in.Backends != nil {
		in, out := &in.Backends, &out.Backends
		*out = make([]WorkloadBalancerBackend, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WorkloadBalancerSpec.
func (in *WorkloadBalancerSpec) DeepCopy() *WorkloadBalancerSpec {
	if in == nil {
		return nil
	}
	out := new(WorkloadBalancerSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WorkloadBalancerStatus) DeepCopyInto(out *WorkloadBalancerStatus) {
	*out = *in
	if in.Ready != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WorkloadBalancerStatus.
func (in *WorkloadBalancerStatus) DeepCopy() *WorkloadBalancerStatus {
	if in == nil {
		return nil
	}
	out := new(WorkloadBalancerStatus)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WorkloadBalancerTemplate) DeepCopyInto(out *WorkloadBalancerTemplate) {
	*out = *in
	in.PodTemplateMetadata.DeepCopyInto(&out.PodTemplateMetadata)
	in.Spec.DeepCopyInto(&out.Spec)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WorkloadBalancerTemplate.
func (in *WorkloadBalancerTemplate) DeepCopy() *WorkloadBalancerTemplate {
	if in == nil {
		return nil
	}
	out := new(WorkloadBalancerTemplate)
	in.DeepCopyInto(out)
	return out
}
